...
public class FeatureComponentDeserializer {
    ...
    FeatureComponent deserialize(JsonObject jsonObject, int numberOfFloatFeatures, Map<Integer, String> featureNames){
        if(jsonObject.get("cat_feature_index") != null
            ...
            return new OneHotFeatureComponent(featureNames.get(numberOfFloatFeatures + jsonObject.get("cat_feature_index").getAsInt()), jsonObject.get("value").getAsInt());
            ...
            return new CategoricalFeatureComponent(featureNames.get(numberOfFloatFeatures + jsonObject.get("cat_feature_index").getAsInt()));
        }
    }
