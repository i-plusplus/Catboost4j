 ...
 */
public class CountCategoricalCondition extends CategoricalCondition {

    public CountCategoricalCondition(Feature feature,
    ...
    public double getDenominator(CategoricalStats categoricalStats){
        return categoricalStats.getDenominator() + getPriorDenominator();
    }
